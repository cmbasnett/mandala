...
boost::shared_ptr<name##_t> resources_get_##name(resource_mgr_t& resources, const std::string& hash)\
{\
    return resources.get<name##_t>(hash_t(hash));\
}\
...
BOOST_PYTHON_MODULE(mandala)
{
    ...
    //move to GLM module?
    MANDALA_PYTHON_DEFINE_VEC2("Vec2f32", float);
    MANDALA_PYTHON_DEFINE_VEC2("Vec2i32", int);
    MANDALA_PYTHON_DEFINE_VEC2("Vec2u32", unsigned int);
    MANDALA_PYTHON_DEFINE_VEC2("Vec2f64", double);

    MANDALA_PYTHON_DEFINE_VEC3("Vec3f32", float);
    MANDALA_PYTHON_DEFINE_VEC3("Vec3i32", int);
    MANDALA_PYTHON_DEFINE_VEC3("Vec3f64", double);
    ...
    //STATES
    class_<state_t, boost::shared_ptr<state_t>, noncopyable>("State", init<>())
    ...
    class_<gui_state_t, bases<state_t>, boost::shared_ptr<gui_state_t>, noncopyable>("GuiState", init<>())
